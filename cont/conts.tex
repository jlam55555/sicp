...
In C, the flow-control capability of \mintinline{c}|goto|, \mintinline{c}|return|, and \mintinline{c}|setjmp| are all a subset of the ability of continuations. Of these, \mintinline{c}|setjmp| is the most powerful and are rougghly equivalent to single-use escape continuations.
