...
This work extends the implementation presented in section 4.3: ``Variations on a Scheme -- Nondeterministic Computing.'' The section uses implicit continuations to implement the \mintinline{scheme}|amb| keyword. This work extends that in two ways by:
\begin{itemize}
...
For this project, I decided to extend the Scheme interpreter by implementing a system of \textit{multiple continuations} in programmer-space via a \mintinline{scheme}|call/cc|-like interface.
